...
<template>
  ...
  >
    ...
    >
      <div
        data-sidebar="sidebar"
        class="text-sidebar-foreground bg-sidebar group-data-[variant=floating]:border-sidebar-border flex size-full flex-col group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border"
      >
        <slot />
      </div>
    </div>
